            ...
            <div class="recomended-sec">
                <div class="row">    
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="item">
                            <img style='height:200px;' src="{!! asset('images/'.$item->book_img) !!}" alt="{{$item->book_name}}">
            ...
            <div class="recent-book-sec">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="item">
                            <a href="{{url('product-single/'.$item->book_url)}}">
                                <img style="width: 167px; height: 260px;" src="{!! asset('images/'.$item->book_img) !!}" alt="{{$item->book_name}}" title="{{$item->book_name}}">
                            </a>
