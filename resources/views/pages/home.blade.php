    ...
    <section class="slider">         
        <div class="container">
            <div id="owl-demo" class="owl-carousel owl-theme">
                <div class="item">
                    <div class="slide">
                        <img src="{{url('images/slide1.jpg')}}" alt="slide1">
                        <div class="content">
                            <div class="title">
        ...
        <div class="container">
            ...
            <div class="row">   
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="item">
                        <!-- <img style="width: 135px; height: 218px;" src="images/img1.jpg" alt="img"> -->
                        <img style="width: 135px; height: 218px;" src="{!! asset('images/'.$item->book_img) !!}" alt="{{$item->book_name}}" />
            ...
            <div class="row">
                ...
                @foreach($data as $item) 
                 <div class="col-lg-2 col-md-3 col-sm-4">
                    <div class="item">
                        <a href="{{url('product-single/'.$item->book_url)}}">
                            <img style="width: 165px; height: 260px" src="{!! asset('images/'.$item->book_img) !!}" alt="{{$item->book_name}}" title="{{$item->book_name}}">                        
                        </a>
                ...
                <!-- <div class="col-lg-2 col-md-3 col-sm-4">
                    <div class="item">
                        <img style="width: 165px; height: 260px" src="images/r1.jpg" alt="img">
