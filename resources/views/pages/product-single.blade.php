                    ...
                    <div id="myCarousel" class="carousel slide">
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="active item carousel-item" data-slide-number="0">         
                                <img style='width: 360px; height: 576px;' src="{{ asset('images/'.$book->book_img)}}" class="img-fluid">
                            </div>
                        ...
                        <ul class="carousel-indicators list-inline">
                            ...
                            <li class="list-inline-item active">
                                ...
                                <img src="{{ asset('images/'.$book->book_img)}}" class="img-fluid">
                            </a>
                            </li>
            ...
            <div class="recomended-sec">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="item">
                            <img style='width: 135px; height: 218px;' src="{{ asset('images/'.$item->book_img) }}" alt="img">
